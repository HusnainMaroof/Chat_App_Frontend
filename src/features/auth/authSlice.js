...
// verifyOTP
export const verifyOTPFun = createAsyncThunk(
  "auth/verify_OTP",
  async (data, thunkAPI) => {
    try {
...
// reSendOTP
export const reSendOTPFun = createAsyncThunk(
  "auth/reSend_OTP",
  async (data, thunkAPI) => {
    try {
...
export const reSetPassLinkFun = createAsyncThunk(
  "auth/reSet_Pass_Link",
  async (data, thunkAPI) => {
    try {
...
export const authMeFun = createAsyncThunk(
  "auth/auth_Me",
  async (_, thunkAPI) => {
    try {
